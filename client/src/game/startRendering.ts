...
type StartGameRendererParams = {
    ...
    playersRef: React.RefObject<Record<string, Player>>;

    projectilesRef: React.RefObject<Record<number, Projectile>>;

    missilesRef: React.RefObject<Record<number, Missile>>;

    collectiblesRef: React.RefObject<Record<number, Collectible>>;

    dropsRef: React.RefObject<Record<number, Drop>>;
};
